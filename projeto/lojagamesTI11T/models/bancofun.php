<?php 
    function inserirfun($conexao,$codUsu,$nomeFun,$funcaoFun,$foneFun,$datanasFun){

        $query="insert into tbfuncionarios(codUsuFK,nomeFun,funcaoFun,foneFun,datanasFun)values('{$codUsu}','{$nomeFun}','{$funcaoFun}',
        '{$foneFun}','{$datanasFun}')";
